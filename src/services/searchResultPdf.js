...
function renderSearchResultPdf(data) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Drawn inside the normal bottom margin, so temporarily zero it out --
    // otherwise pdfkit's automatic page-break logic sees this as overflow
    // and silently pushes each footer line onto its own new page.
